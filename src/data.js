...
export const lixeiraInfo = {
  sellerName: 'Carlos Roberto R. Vasconcellos',
  sellerRole: 'Vendedor Especializado',
  size: '20 x 30 cm (tamanho padrão)',
  price: 300,
  installments: 'Pague em 2x de R$ 150,00',
  material: 'Ferro Galvanizado',
  coverage: 'Niterói, São Gonçalo, Maricá e região',
  features: [
    { icon: 'shield', title: 'Ferro Galvanizado', text: 'Alta resistência à ferrugem e ao tempo' },
    { icon: 'handdollar', title: 'Preço Justo', text: 'R$ 300,00 ou 2x de R$ 150,00' },
    { icon: 'fasttruck', title: 'Entrega Rápida', text: 'Niterói, São Gonçalo, Maricá e região' },
    { icon: 'headset', title: 'Atendimento Direto', text: 'Fale direto com o vendedor pelo WhatsApp' },
  ],
}

// ---------- Sinuca Jovane (Vendedor: Carlos Roberto) ----------
export const sinucaInfo = {
  sellerName: 'Carlos Roberto',
  coverage: 'Entrega para todo Rio de Janeiro',
  features: [
    { icon: 'thumbsbadge', title: 'Qualidade Garantida', text: 'Mesas e equipamentos de alto padrão' },
    { icon: 'fasttruck', title: 'Entrega e Montagem', text: 'Levamos e montamos no seu endereço' },
    { icon: 'handdollar', title: 'Orçamento sem Compromisso', text: 'Fale com a gente e peça seu orçamento' },
  ],
}

export const sinucaProducts = [
  { id: 'mesa-vasco', name: 'Mesa Vasco', tag: 'Personalizada', img: 'mesa-vasco' },
  { id: 'mesa-flamengo', name: 'Mesa Flamengo', tag: 'Personalizada', img: 'mesa-flamengo' },
  { id: 'mesa-botafogo', name: 'Mesa Botafogo', tag: 'Personalizada', img: 'mesa-botafogo' },
  { id: 'mesa-vermelha', name: 'Mesa Vermelha', tag: 'Premium', img: 'mesa-vermelha' },
